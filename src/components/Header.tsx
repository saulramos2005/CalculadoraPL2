...
export function Header({ isDarkMode, toggleTheme }: HeaderProps) {
  return (
    ...
    >
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-4 px-4 py-6 sm:flex-row sm:items-center sm:px-6 lg:px-8">
        <div className="flex flex-col gap-2 pr-12 sm:pr-0">
          ...
          <h1 className="text-xl font-semibold tracking-tight sm:text-2xl">Calculadora de Programación Lineal</h1>
        ...
        <button
          onClick={toggleTheme}
          className="absolute right-4 top-6 sm:static sm:shrink-0 rounded-lg border border-slate-200 p-2 text-slate-600 transition-colors hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
