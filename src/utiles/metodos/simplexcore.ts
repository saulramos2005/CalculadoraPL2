import { ProblemInput, IterationStep  } from "@/data/interfaces";
...
export function simplexCore(params: {
  tableau: number[][];
  basis: number[];
  headers: string[];
  mode: "primal" | "dual";
...
export function buildSimplexModel(problem: ProblemInput, allowNegativeB: boolean) {
